# incineroar-support-set Specification
...
El sistema SHALL tener un archivo de set individual para Incineroar (Fuego/Siniestro) con la habilidad Intimidación, naturaleza Cauta (+Def. Esp / -At. Esp), objeto Baya Zarza, los movimientos Sorpresa, Último Turno, Golpe al Cuello y Envite Ígneo, y un reparto de 32 PS / 32 Def. Esp / 2 Defensa (total 66 EVs).
